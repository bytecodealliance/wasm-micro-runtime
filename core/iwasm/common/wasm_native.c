...
invoke_I_I(void *func_ptr, void *exec_env, int32 *argv, int32 *argv_ret)
{
    ...
    int64 ret = native_code(exec_env, GET_I64_FROM_ADDR(argv));
    PUT_I64_TO_ADDR(argv_ret, ret);
}
...
invoke_iI_I(void *func_ptr, void *exec_env, int32 *argv, int32 *argv_ret)
{
    ...
    int64 ret = native_code(exec_env, argv[0], GET_I64_FROM_ADDR(argv + 1));
    PUT_I64_TO_ADDR(argv_ret, ret);
}
...
invoke_Ii_I(void *func_ptr, void *exec_env, int32 *argv, int32 *argv_ret)
{
    ...
    int64 ret = native_code(exec_env, GET_I64_FROM_ADDR(argv), argv[2]);
    PUT_I64_TO_ADDR(argv_ret, ret);
}
...
invoke_Iiii_I(void *func_ptr, void *exec_env, int32 *argv, int32 *argv_ret)
{
    ...
    int64 ret = native_code(exec_env, GET_I64_FROM_ADDR(argv), argv[2], argv[3],
                            argv[4]);
    PUT_I64_TO_ADDR(argv_ret, ret);
}
