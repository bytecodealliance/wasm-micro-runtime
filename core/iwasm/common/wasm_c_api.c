    ...
    for (i = 0; i != import_count; ++i) {
        ...
        if (i < import_func_count) {
            ...
            if ((*module)->module_type == Wasm_Module_Bytecode) {
                ...
                module_name_rt = import->u.names.module_name;
                field_name_rt = import->u.names.field_name;
                val_type_rt = import->u.global.common.type;
                mutability_rt = import->u.global.common.is_mutable;
            }
#endif
            ...
            if ((*module)->module_type == Wasm_Module_AoT) {
                ...
                val_type_rt = import->common.type;
                mutability_rt = import->common.is_mutable;
            }
#endif
               ...
               const wasm_val_t *v)
{
    ...
    if (global_idx_rt < module_aot->import_global_count) {
        ...
        val_type_rt = module_aot->import_globals[global_idx_rt].common.type;
    }
    else {
        data_offset =
                         ...
                         WASMModuleInstanceCommon *inst_comm_rt)
{
    ...
    if (inst_comm_rt->module_type == Wasm_Module_AoT) {
        ...
        if (global_idx_rt < module_aot->import_global_count) {
            ...
            val_type_rt = global_import_aot->common.type;
            is_mutable = global_import_aot->common.is_mutable;
        }
        else {
            AOTGlobal *global_aot =
                module_aot->globals
                + (global_idx_rt - module_aot->import_global_count);
            val_type_rt = global_aot->common.type;
            is_mutable = global_aot->common.is_mutable;
        }
    }
#endif
                   ...
                   wasm_global_t *import)
{
    ...
    if (!cmp_val_kind_with_val_type(
            ...
            imported_global_interp->u.global.common.type))
        return false;
