...
wasm_runtime_dump_module_mem_consumption(const WASMModuleCommon *module)
{
    ...
    LOG_VERBOSE("    types size: %u\n", mem_conspn.types_size);
    LOG_VERBOSE("    imports size: %u\n", mem_conspn.imports_size);
    LOG_VERBOSE("    funcs size: %u\n", mem_conspn.functions_size);
    LOG_VERBOSE("    tables size: %u\n", mem_conspn.tables_size);
    LOG_VERBOSE("    memories size: %u\n", mem_conspn.memories_size);
    LOG_VERBOSE("    globals size: %u\n", mem_conspn.globals_size);
    LOG_VERBOSE("    exports size: %u\n", mem_conspn.exports_size);
    LOG_VERBOSE("    table segs size: %u\n", mem_conspn.table_segs_size);
    LOG_VERBOSE("    data segs size: %u\n", mem_conspn.data_segs_size);
    LOG_VERBOSE("    const strings size: %u\n", mem_conspn.const_strs_size);
#if WASM_ENABLE_AOT != 0
    LOG_VERBOSE("    aot code size: %u\n", mem_conspn.aot_code_size);
#endif
}
    ...
    const WASMModuleInstanceCommon *module_inst)
{
    ...
    LOG_VERBOSE("WASM module inst memory consumption, total size: %u\n",
                mem_conspn.total_size);
    LOG_VERBOSE("    module inst struct size: %u\n",
                mem_conspn.module_inst_struct_size);
    LOG_VERBOSE("    memories size: %u\n", mem_conspn.memories_size);
    LOG_VERBOSE("        app heap size: %u\n", mem_conspn.app_heap_size);
    LOG_VERBOSE("    tables size: %u\n", mem_conspn.tables_size);
    LOG_VERBOSE("    functions size: %u\n", mem_conspn.functions_size);
    LOG_VERBOSE("    globals size: %u\n", mem_conspn.globals_size);
    LOG_VERBOSE("    exports size: %u\n", mem_conspn.exports_size);
}
...
wasm_runtime_dump_mem_consumption(WASMExecEnv *exec_env)
{
    ...
    if (max_aux_stack_used != (uint32)-1)
        LOG_VERBOSE("Total auxiliary stack used: %u\n", max_aux_stack_used);
    else
    ...
    LOG_VERBOSE("Total app heap used: %u\n", app_heap_peak_size);
}
