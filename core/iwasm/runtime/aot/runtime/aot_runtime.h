...
#include "../../vmcore-wasm/wasm_runtime.h"
#include "../compiler/aot.h"
#if WASM_ENABLE_JIT != 0
#include "../compiler/aot_llvm.h"
#endif
...
typedef struct AOTModuleInstance {
    ...
    uint32 ext_mem_data_size;
    AOTPointer ext_mem_data;
    AOTPointer ext_mem_data_end;
...
typedef WASMSection AOTSection;
 ...
 * arguments.
 *
 * @param module_inst the AOT module instance which the function belongs to
...
bool
aot_attach_current_thread(AOTModuleInstance *module_inst,
                          void *thread_data);

void
aot_detach_current_thread(AOTModuleInstance *module_inst);
