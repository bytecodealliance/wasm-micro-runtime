                    ...
                    char *error_buf, uint32 error_buf_size)
{
    ...
    for (i = 0; i < module->import_global_count; i++) {
        ...
        read_uint8(buf, buf_end, import_globals[i].common.type);
        read_uint8(buf, buf_end, import_globals[i].common.is_mutable);
        ...
        if (wasm_native_lookup_libc_builtin_global(
                ...
                &tmp_global)) {
            if (tmp_global.common.type != import_globals[i].common.type
                || tmp_global.common.is_mutable
                       != import_globals[i].common.is_mutable) {
                set_error_buf(error_buf, error_buf_size,
        ...
        import_globals[i].size =
            wasm_value_type_size(import_globals[i].common.type);
             ...
             char *error_buf, uint32 error_buf_size)
{
    ...
    for (i = 0; i < module->global_count; i++) {
        read_uint8(buf, buf_end, globals[i].common.type);
        read_uint8(buf, buf_end, globals[i].common.is_mutable);
        ...
        globals[i].size = wasm_value_type_size(globals[i].common.type);
