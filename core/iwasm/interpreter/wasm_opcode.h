...
typedef enum WASMGCEXTOpcode {
    ...
    WASM_OP_STRINGVIEW_WTF16_GET_CODEUNIT = 0x9a,   /* stringview_wtf16.get_codeunit */
    ...
    WASM_OP_STRING_NEW_LOSSY_UTF8_ARRAY = 0xb4,     /* string.new_lossy_utf8_array */
    WASM_OP_STRING_NEW_WTF8_ARRAY = 0xb5,           /* string.new_wtf8_array */
    WASM_OP_STRING_ENCODE_LOSSY_UTF8_ARRAY = 0xb6,  /* string.encode_lossy_utf8_array */
