                       ...
                       char *error_buf, uint32 error_buf_size)
{
    ...
    if (global_index >= module->import_global_count
        || (module->import_globals + global_index)
                    ...
                    char *error_buf, uint32 error_buf_size)
{
    ...
    for (i = 0; i < module->import_global_count; i++, import++) {
        ...
        global->type = global_import->common.type;
        global->is_mutable = global_import->common.is_mutable;
#if WASM_ENABLE_GC != 0
    ...
    for (i = 0; i < module->global_count; i++) {
        ...
        global->type = module->globals[i].common.type;
        global->is_mutable = module->globals[i].common.is_mutable;
#if WASM_ENABLE_FAST_JIT != 0
