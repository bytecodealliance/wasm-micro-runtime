...
static wasi_errno_t
wasi_args_get(wasm_exec_env_t exec_env,
...
static wasi_errno_t
wasi_fd_renumber(wasm_exec_env_t exec_env,
             ...
             int32 newoffset_offset /* wasi_filesize_t * */)
{
    ...
    if (!validate_app_addr(newoffset_offset, sizeof(wasi_filesize_t)))
        return (wasi_errno_t)-1;
    ...
    newoffset_app = (wasi_filesize_t*)addr_app_to_native(newoffset_offset);
    *newoffset_app = newoffset;
...
static wasi_errno_t
wasi_fd_write(wasm_exec_env_t exec_env,
              wasi_fd_t fd,
              int32 iovs_offset /* const wasi_ciovec_t * */,
              uint32 iovs_len,
              int32 nwritten_offset /* size_t * */)
...
static wasi_errno_t
wasi_random_get(wasm_exec_env_t exec_env,
