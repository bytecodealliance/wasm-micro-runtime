...
typedef struct __wasi_bh_linger {
    uint8_t l_onoff;
    uint32_t l_linger_s;
} __wasi_bh_linger;

typedef struct __wasi_bh_in_addr_t {
    uint32_t s_addr;
} __wasi_bh_in_addr_t;

typedef struct __wasi_bh_ip_mreq_t {
    __wasi_bh_in_addr_t imr_multiaddr;
    __wasi_bh_in_addr_t imr_interface;
} __wasi_bh_ip_mreq_t;
