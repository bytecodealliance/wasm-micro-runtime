...
#define LOG_ERROR(...) \
    bh_log(BH_LOG_LEVEL_ERROR, __FILE__, __LINE__, __VA_ARGS__)
#define LOG_WARNING(...) \
    bh_log(BH_LOG_LEVEL_WARNING, __FILE__, __LINE__, __VA_ARGS__)
#define LOG_VERBOSE(...) \
    bh_log(BH_LOG_LEVEL_VERBOSE, __FILE__, __LINE__, __VA_ARGS__)
