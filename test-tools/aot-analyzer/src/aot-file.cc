...
AoTFile::AoTFile(const char *file_name) : BinaryFile(file_name) {
...
Result AoTFile::ParseTargetInfo() {
...
AOTTargetInfo AoTFile::GetTargetInfo() { return target_info_; }

std::string AoTFile::GetBinTypeName(uint16_t bin_type) {
    std::string name = "";
    switch (bin_type) {
...
std::string AoTFile::GetExectuionTypeName(uint16_t e_type) {
    std::string name = "";
    switch (e_type) {
        case E_TYPE_NONE: {
            name = "NONE";
...
std::string AoTFile::GetExectuionMachineName(uint16_t e_machine) {
    std::string machine = "";
    switch (e_machine) {
        case E_MACHINE_386: {
            machine = "386";
