...
function help()
{
    ...
    echo "-m set compile target of iwasm(x86_64|x86_32|armv7|armv7_vfp|thumbv7|thumbv7_vfp|riscv32|riscv32_ilp32f|riscv32_ilp32d|riscv64|riscv64_lp64f|riscv64_lp64d|aarch64|aarch64_vfp)"
...
TARGET_LIST=("AARCH64" "AARCH64_VFP" "ARMV7" "ARMV7_VFP" "THUMBV7" "THUMBV7_VFP" "RISCV32" "RISCV32_ILP32F" "RISCV32_ILP32D" "RISCV64" "RISCV64_LP64F" "RISCV64_LP64D")
