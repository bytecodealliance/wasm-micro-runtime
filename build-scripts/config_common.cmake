...
if (NOT DEFINED WAMR_BUILD_INVOKE_NATIVE_QUICK)
  # Enable invoke native quick by default
  set (WAMR_BUILD_INVOKE_NATIVE_QUICK 1)
endif ()
if (WAMR_BUILD_INVOKE_NATIVE_QUICK EQUAL 1)
  add_definitions (-DWASM_ENABLE_INVOKE_NATIVE_QUICK=1)
  message ("     Invoke native quick enabled")
else ()
  add_definitions (-DWASM_ENABLE_INVOKE_NATIVE_QUICK=0)
  message ("     Invoke native quick disabled")
endif ()
