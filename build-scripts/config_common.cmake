...
if (WAMR_BUILD_JIT EQUAL 1)
  if (WAMR_BUILD_AOT EQUAL 1)
    ...
    if (NOT WAMR_BUILD_MCJIT EQUAL 1)
      # Disable MCJIT by default
      set (WAMR_BUILD_MCJIT 0)
    else ()
      # MCJIT doesn't support lazy compilation
...
if (WAMR_BUILD_JIT EQUAL 1)
  message ("     WAMR LLVM JIT enabled")
  add_definitions("-DWASM_ENABLE_JIT=1")
  if (WAMR_BUILD_MCJIT EQUAL 1)
    message ("     WAMR LLVM MC JIT enabled")
    add_definitions("-DWASM_ENABLE_MCJIT=1")
  else ()
    message ("     WAMR LLVM ORC JIT enabled")
    add_definitions("-DWASM_ENABLE_MCJIT=0")
  endif ()
