...
own wasm_trap_t *
neg_callback(const wasm_val_vec_t *args, wasm_val_vec_t *results)
{
    printf("Calling back...\n");
...
void
check_table(wasm_table_t *table, int32_t i, bool expect_set)
{
...
void
check_call(wasm_func_t *func, int32_t arg1, int32_t arg2, int32_t expected)
{
...
void
check_trap(wasm_func_t *func, int32_t arg1, int32_t arg2)
{
    wasm_val_t vs[2] = { WASM_I32_VAL(arg1), WASM_I32_VAL(arg2) };
    wasm_val_t r[1] = { WASM_INIT_VAL };
    wasm_val_vec_t args = WASM_ARRAY_VEC(vs);
