...
void
print_mutability(wasm_mutability_t mut)
{
    switch (mut) {
        case WASM_VAR:
            printf("var");
...
void
print_limits(const wasm_limits_t *limits)
{
...
void
print_valtype(const wasm_valtype_t *type)
{
...
void
print_valtypes(const wasm_valtype_vec_t *types)
{
    bool first = true;
...
void
print_externtype(const wasm_externtype_t *type)
{
...
void
print_name(const wasm_name_t *name)
{
