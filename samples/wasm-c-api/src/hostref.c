...
wasm_table_t *
get_export_table(const wasm_extern_vec_t *exports, size_t i)
{
...
own wasm_ref_t *
call_v_r(const wasm_func_t *func)
{
    printf("call_v_r... ");
    fflush(stdout);
...
void
call_r_v(const wasm_func_t *func, wasm_ref_t *ref)
{
    printf("call_r_v... ");
    fflush(stdout);
...
own wasm_ref_t *
call_r_r(const wasm_func_t *func, wasm_ref_t *ref)
{
    printf("call_r_r... ");
    fflush(stdout);
    wasm_val_t vs[1] = { WASM_REF_VAL(ref) };
...
void
call_ir_v(const wasm_func_t *func, int32_t i, wasm_ref_t *ref)
{
    printf("call_ir_v... ");
    fflush(stdout);
...
own wasm_ref_t *
call_i_r(const wasm_func_t *func, int32_t i)
{
    printf("call_i_r... ");
    fflush(stdout);
...
void
check(own wasm_ref_t *actual, const wasm_ref_t *expected)
{
    if (actual != expected
