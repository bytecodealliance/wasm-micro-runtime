...
own wasm_trap_t *
print_callback(const wasm_val_vec_t *args, wasm_val_vec_t *results)
{
    printf("Calling back...\n> ");
...
// A function closure.
own wasm_trap_t *
closure_callback(void *env, const wasm_val_vec_t *args, wasm_val_vec_t *results)
{
    int i = *(int *)env;
...
main(int argc, const char *argv[])
{
    ...
    wasm_extern_t *externs[] = { wasm_func_as_extern(print_func),
